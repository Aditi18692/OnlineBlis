...
:checksumcheck
	echo Updating to C4G BLIS v3.4... Please wait...
...
:updation
	...
	echo Starting C4G BLIS v3.4 source code update...
...
:success
	...
	echo C4G BLIS updated Successfully to v3.4!
	echo Starting C4G BLIS v3.4 ...
	start BLIS.exe
	goto eofExit
