...
:checksumcheck
	echo Updating to C4G BLIS v3.0... Please wait...
...
:updation
	...
	echo Starting C4G BLIS v3.0 source code update...
...
:success
	...
	echo C4G BLIS updated Successfully to v3.0!
	echo Starting C4G BLIS v3.0 ...
	start BLIS.exe
	goto eofExit
...
:checkfailure
	...
	echo BLIS Update Failed!
	echo Try again.
	echo If error persists, email arajagopal@gatech.edu to report this error.
	goto eof
